...
public enum OppoBlurayPlayerCommand {
	...
	/*
	 UPL
		...
		speed level
		SFWn – Slow forward mode. Where n is a number of 1...4 to indicate the
		speed level (1 = 1⁄2, 2 = 1⁄4, 3 = 1/8, 4 = 1/16)
		SRVn – Slow reverse mode. Where n is a number of 1...4 to indicate the
		speed level (1 = 1⁄2, 2 = 1⁄4, 3 = 1/8, 4 = 1/16)
		HOME – in home menu
